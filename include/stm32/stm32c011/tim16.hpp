...
namespace tim16 {
  ...
  template <std::uint32_t baseaddress>
  using tim16_ccmr1_input_t =
    tim16_ccmr1_input_tt<"TIM16_CCMR1_input", baseaddress, 24>;

  template <std::uint32_t baseaddress>
  using tim16_ccmr1_output_t =
    tim16_ccmr1_output_tt<"TIM16_CCMR1_output", baseaddress, 24>;
