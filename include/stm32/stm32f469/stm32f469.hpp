...
namespace c_adc {
  ...
  template <stdx::ct_string name, std::uint32_t baseaddress>
  using c_adc_t = groov::group<name,
                               groov::mmio_bus<>,
                               csr<baseaddress>,
                               ccr<baseaddress>,
                               cdr<baseaddress>>;
...
namespace otg_fs_global {
  ...
  using otg_fs_global_t = groov::group<name,
                                       ...
                                       fs_dieptxf4<baseaddress>,
                                       fs_dieptxf5<baseaddress>>;
...
namespace dsihost {
  ...
  template <stdx::ct_string name, std::uint32_t baseaddress>
  using dsihost_t = groov::group<name,
                                 groov::mmio_bus<>,
                                 dsi_vr<baseaddress>,
                                 dsi_cr<baseaddress>,
                                 dsihsot_ccr<baseaddress>,
