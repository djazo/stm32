...
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using dsihost_dsi_pcconfr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
using dsihost_dsi_vmccr_v1_tt =
  groov::reg<name,
             ...
             common::access::rw,
               ...
               groov::field<"lphfe", common::bit_enable, 13, 13>,
...
// dsihost_dsi_wpcr5_v1: DSI_WPCR5
// Used by: DSIHOST
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using dsihost_dsi_wpcr5_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
...
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using dsihost_dsihsot_ccr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             common::access::rw,
