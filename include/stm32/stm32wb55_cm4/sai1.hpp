...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bslotr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bclrfr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::wo,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using aslotr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"SLOTEN", std::uint16_t, 31, 16 >,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using aclrfr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::wo,
  groov::field<"RESERVED1", std::uint32_t, 31, 7 ,access::ro>,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using pdmdly_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
