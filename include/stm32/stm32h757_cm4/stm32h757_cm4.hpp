...
constexpr std::uint32_t IWDG2_BASE = 0x58004c00;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t WWDG2_BASE = 0x40002c00;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t DSIHOST_BASE = 0x50000000;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t ART_BASE = 0x40024400;
template <stdx::ct_string name, std::uint32_t baseaddress>
