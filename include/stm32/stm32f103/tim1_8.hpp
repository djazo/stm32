...
namespace tim {
  namespace tima {
    ...
    template <stdx::ct_string name,
              std::uint32_t   baseaddress,
              std::uint32_t   offset>
    using ccmr1_output_tt = groov::reg<
      name,
      std::uint32_t,
      baseaddress + offset,
      common::access::rw,
    ...
    template <stdx::ct_string name,
              std::uint32_t   baseaddress,
              std::uint32_t   offset>
    using ccmr1_input_tt = groov::reg<
      name,
      std::uint32_t,
      baseaddress + offset,
      common::access::rw,
    ...
    template <stdx::ct_string name,
              std::uint32_t   baseaddress,
              std::uint32_t   offset>
    using ccmr2_output_tt = groov::reg<
      name,
      std::uint32_t,
      baseaddress + offset,
      common::access::rw,
    ...
    template <stdx::ct_string name,
              std::uint32_t   baseaddress,
              std::uint32_t   offset>
    using ccmr2_input_tt = groov::reg<
      name,
      std::uint32_t,
      baseaddress + offset,
      common::access::rw,
