...
namespace ethernet_mac {
  ...
  using macrwuffr_tt =
    groov::reg<name,
               ...
               baseaddress + offset,
               common::access::rw,
               groov::field<"MACRWUFF", std::uint32_t, 31, 0>>;

  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using macpmtcsr_tt = groov::reg<
    name,
    std::uint32_t,
    baseaddress + offset,
    common::access::rw,
