...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using cr1_fifo_enabled_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using cr1_fifo_disabled_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using isr_fifo_enabled_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using isr_fifo_disabled_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
using cr1_fifo_enabled_t = cr1_fifo_enabled_tt<"CR1_FIFO_ENABLED",baseaddress,0>;

template <std::uint32_t baseaddress>
using cr1_fifo_disabled_t = cr1_fifo_disabled_tt<"CR1_FIFO_DISABLED",baseaddress,0>;
...
template <std::uint32_t baseaddress>
using isr_fifo_enabled_t = isr_fifo_enabled_tt<"ISR_FIFO_ENABLED",baseaddress,28>;

template <std::uint32_t baseaddress>
using isr_fifo_disabled_t = isr_fifo_disabled_tt<"ISR_FIFO_DISABLED",baseaddress,28>;
