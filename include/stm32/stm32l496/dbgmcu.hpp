...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using apb1_fzr1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using apb1_fzr2_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using apb2_fzr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::uint32_t baseaddress>
using apb1_fzr1_t = apb1_fzr1_tt<"APB1_FZR1",baseaddress,8>;

template <std::uint32_t baseaddress>
using apb1_fzr2_t = apb1_fzr2_tt<"APB1_FZR2",baseaddress,12>;

template <std::uint32_t baseaddress>
using apb2_fzr_t = apb2_fzr_tt<"APB2_FZR",baseaddress,16>;
