...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_ccr0_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cndtr0_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar0_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar2_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar3_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar4_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar5_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar6_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using bdma_cm1ar7_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  >;
