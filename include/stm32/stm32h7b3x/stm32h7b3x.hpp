...
constexpr std::uint32_t BDMA1_BASE = 0x48022c00;
template <stdx::ct_string name, std::uint32_t baseaddress>
using bdma1_t = groov::group<
  name, groov::mmio_bus<>,
...
constexpr std::uint32_t BDMA2_BASE = 0x58025400;
template <stdx::ct_string name, std::uint32_t baseaddress>
using bdma2_t = groov::group<
  name, groov::mmio_bus<>,
  bdma_isr<baseaddress>,
  bdma_ifcr<baseaddress>,
  bdma_ccr0<baseaddress>,
...
constexpr std::uint32_t CRYP_BASE = 0x48021000;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t DFSDM1_BASE = 0x40017800;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t DFSDM2_BASE = 0x58006c00;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t DELAY_BLOCK_OCTOSPI1_BASE = 0x52006000;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t DELAY_BLOCK_OCTOSPI2_BASE = 0x5200b000;
template <stdx::ct_string name, std::uint32_t baseaddress>
using delay_block_octospi2_t = groov::group<
  name, groov::mmio_bus<>,
  cr<baseaddress>,
  cfgr<baseaddress>
  >;
...
constexpr std::uint32_t FDCAN_BASE = 0x4000a400;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t HASH_BASE = 0x48021400;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t HSEM_BASE = 0x48020800;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t OCTOSPI2_BASE = 0x5200a000;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t OCTOSPI1_CONTROL_REGISTER_BASE = 0x52005000;
template <stdx::ct_string name, std::uint32_t baseaddress>
using octospi1_control_register_t = groov::group<
  name, groov::mmio_bus<>,
  cr<baseaddress>,
  dcr1<baseaddress>,
  dcr2<baseaddress>,
...
constexpr std::uint32_t OTFDEC1_BASE = 0x5200b800;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t OTFDEC2_BASE = 0x5200bc00;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t OCTOSPII_O_MANAGER_BASE = 0x5200b400;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t RAMECC_BASE = 0x52009000;
template <stdx::ct_string name, std::uint32_t baseaddress>
using ramecc_t = groov::group<
  name, groov::mmio_bus<>,
  ier<baseaddress>,
  m1cr<baseaddress>,
  m1sr<baseaddress>,
...
constexpr std::uint32_t TAMP_BASE = 0x58004400;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t TT_FDCAN_BASE = 0x4000a000;
template <stdx::ct_string name, std::uint32_t baseaddress>
...
constexpr std::uint32_t USART9_BASE = 0x40011800;
template <stdx::ct_string name, std::uint32_t baseaddress>
using usart9_t = groov::group<
  name, groov::mmio_bus<>,
  cr1<baseaddress>,
  cr2<baseaddress>,
  cr3<baseaddress>,
...
constexpr std::uint32_t USART10_BASE = 0x40011c00;
template <stdx::ct_string name, std::uint32_t baseaddress>
using usart10_t = groov::group<
  name, groov::mmio_bus<>,
  cr1<baseaddress>,
  cr2<baseaddress>,
  cr3<baseaddress>,
