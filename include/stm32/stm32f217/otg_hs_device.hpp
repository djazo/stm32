...
template <std::uint32_t baseaddress>
using otg_hs_diepeachmsk1_t = otg_hs_diepeachmsk1_tt<"OTG_HS_DIEPEACHMSK1",baseaddress,64>;

template <std::uint32_t baseaddress>
using otg_hs_doepeachmsk1_t = otg_hs_doepeachmsk1_tt<"OTG_HS_DOEPEACHMSK1",baseaddress,128>;
