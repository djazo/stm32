...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using tx_ordset_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using tx_paysz_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using rx_ordset_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using rx_paysz_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"RESERVED0", std::uint32_t, 31, 10 ,access::ro>,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using rx_ordext1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"RESERVED0", std::uint16_t, 31, 20 ,access::ro>,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using rx_ordext2_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"RESERVED0", std::uint16_t, 31, 20 ,access::ro>,
...
using cfg1_t = cfg1_tt<"CFG1",baseaddress,0>;

template <std::uint32_t baseaddress>
using cfg2_t = cfg2_tt<"CFG2",baseaddress,4>;

template <std::uint32_t baseaddress>
using cfg3_t = cfg3_tt<"CFG3",baseaddress,8>;
...
template <std::uint32_t baseaddress>
using ipver_t = ipver_tt<"IPVER",baseaddress,1012>;

template <std::uint32_t baseaddress>
using ipid_t = ipid_tt<"IPID",baseaddress,1016>;
