...
template <std::uint32_t baseaddress>
using otg_hs_dieptsiz6_t = otg_hs_dieptsiz6_tt<"OTG_HS_DIEPTSIZ6",baseaddress,416>;

template <std::uint32_t baseaddress>
using otg_hs_dtxfsts6_t = otg_hs_dtxfsts6_tt<"OTG_HS_DTXFSTS6",baseaddress,420>;

template <std::uint32_t baseaddress>
using otg_hs_dieptsiz7_t = otg_hs_dieptsiz7_tt<"OTG_HS_DIEPTSIZ7",baseaddress,424>;

template <std::uint32_t baseaddress>
using otg_hs_dtxfsts7_t = otg_hs_dtxfsts7_tt<"OTG_HS_DTXFSTS7",baseaddress,428>;
