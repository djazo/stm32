...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using otg_hs_diepeachmsk1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using otg_hs_doepeachmsk1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::uint32_t baseaddress>
using otg_hs_diepeachmsk1_t = otg_hs_diepeachmsk1_tt<"OTG_HS_DIEPEACHMSK1",baseaddress,68>;

template <std::uint32_t baseaddress>
using otg_hs_doepeachmsk1_t = otg_hs_doepeachmsk1_tt<"OTG_HS_DOEPEACHMSK1",baseaddress,132>;
...
template <std::uint32_t baseaddress>
using otg_hs_diepdma1_t = otg_hs_diepdma1_tt<"OTG_HS_DIEPDMA1",baseaddress,276>;

template <std::uint32_t baseaddress>
using otg_hs_diepdma2_t = otg_hs_diepdma2_tt<"OTG_HS_DIEPDMA2",baseaddress,308>;

template <std::uint32_t baseaddress>
using otg_hs_diepdma3_t = otg_hs_diepdma3_tt<"OTG_HS_DIEPDMA3",baseaddress,340>;

template <std::uint32_t baseaddress>
using otg_hs_diepdma4_t = otg_hs_diepdma4_tt<"OTG_HS_DIEPDMA4",baseaddress,372>;

template <std::uint32_t baseaddress>
using otg_hs_diepdma5_t = otg_hs_diepdma5_tt<"OTG_HS_DIEPDMA5",baseaddress,404>;
