...
template <std::uint32_t baseaddress>
using or2_t = or2_tt<"OR2",baseaddress,96>;

template <std::uint32_t baseaddress>
using or3_t = or3_tt<"OR3",baseaddress,100>;
