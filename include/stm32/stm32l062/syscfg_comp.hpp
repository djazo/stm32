...
template <std::uint32_t baseaddress>
using cfgr3_t = cfgr3_tt<"CFGR3",baseaddress,32>;

template <std::uint32_t baseaddress>
using comp1_csr_t = comp1_csr_tt<"COMP1_CSR",baseaddress,24>;

template <std::uint32_t baseaddress>
using comp2_csr_t = comp2_csr_tt<"COMP2_CSR",baseaddress,28>;
