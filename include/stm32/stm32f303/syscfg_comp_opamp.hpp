...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using comp5_csr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using comp7_csr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using syscfg_cfgr4_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::uint32_t baseaddress>
using comp1_csr_t = comp1_csr_tt<"COMP1_CSR",baseaddress,28>;

template <std::uint32_t baseaddress>
using comp2_csr_t = comp2_csr_tt<"COMP2_CSR",baseaddress,32>;

template <std::uint32_t baseaddress>
using comp3_csr_t = comp3_csr_tt<"COMP3_CSR",baseaddress,36>;

template <std::uint32_t baseaddress>
using comp4_csr_t = comp4_csr_tt<"COMP4_CSR",baseaddress,40>;

template <std::uint32_t baseaddress>
using comp5_csr_t = comp5_csr_tt<"COMP5_CSR",baseaddress,44>;

template <std::uint32_t baseaddress>
using comp6_csr_t = comp6_csr_tt<"COMP6_CSR",baseaddress,48>;

template <std::uint32_t baseaddress>
using comp7_csr_t = comp7_csr_tt<"COMP7_CSR",baseaddress,52>;

template <std::uint32_t baseaddress>
using opamp1_csr_t = opamp1_csr_tt<"OPAMP1_CSR",baseaddress,56>;

template <std::uint32_t baseaddress>
using opamp2_csr_t = opamp2_csr_tt<"OPAMP2_CSR",baseaddress,60>;

template <std::uint32_t baseaddress>
using opamp3_csr_t = opamp3_csr_tt<"OPAMP3_CSR",baseaddress,64>;

template <std::uint32_t baseaddress>
using opamp4_csr_t = opamp4_csr_tt<"OPAMP4_CSR",baseaddress,68>;

template <std::uint32_t baseaddress>
using syscfg_cfgr3_t = syscfg_cfgr3_tt<"SYSCFG_CFGR3",baseaddress,80>;

template <std::uint32_t baseaddress>
using syscfg_cfgr4_t = syscfg_cfgr4_tt<"SYSCFG_CFGR4",baseaddress,72>;
