...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using alrabinr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"SS", std::uint32_t, 31, 0 >
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using alrbbinr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"SS", std::uint32_t, 31, 0 >
...
template <std::uint32_t baseaddress>
using alrabinr_t = alrabinr_tt<"ALRABINR",baseaddress,112>;

template <std::uint32_t baseaddress>
using alrbbinr_t = alrbbinr_tt<"ALRBBINR",baseaddress,116>;
