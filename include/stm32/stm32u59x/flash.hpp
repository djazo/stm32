...
template <std::uint32_t baseaddress>
using flash_sec1bbr5_t = flash_sec1bbr5_tt<"FLASH_SEC1BBR5",baseaddress,144>;

template <std::uint32_t baseaddress>
using flash_sec1bbr6_t = flash_sec1bbr6_tt<"FLASH_SEC1BBR6",baseaddress,148>;

template <std::uint32_t baseaddress>
using flash_sec1bbr7_t = flash_sec1bbr7_tt<"FLASH_SEC1BBR7",baseaddress,152>;

template <std::uint32_t baseaddress>
using flash_sec1bbr8_t = flash_sec1bbr8_tt<"FLASH_SEC1BBR8",baseaddress,156>;
...
template <std::uint32_t baseaddress>
using flash_sec2bbr5_t = flash_sec2bbr5_tt<"FLASH_SEC2BBR5",baseaddress,176>;

template <std::uint32_t baseaddress>
using flash_sec2bbr6_t = flash_sec2bbr6_tt<"FLASH_SEC2BBR6",baseaddress,180>;

template <std::uint32_t baseaddress>
using flash_sec2bbr7_t = flash_sec2bbr7_tt<"FLASH_SEC2BBR7",baseaddress,184>;

template <std::uint32_t baseaddress>
using flash_sec2bbr8_t = flash_sec2bbr8_tt<"FLASH_SEC2BBR8",baseaddress,188>;
...
template <std::uint32_t baseaddress>
using flash_priv1bbr5_t = flash_priv1bbr5_tt<"FLASH_PRIV1BBR5",baseaddress,224>;

template <std::uint32_t baseaddress>
using flash_priv1bbr6_t = flash_priv1bbr6_tt<"FLASH_PRIV1BBR6",baseaddress,228>;

template <std::uint32_t baseaddress>
using flash_priv1bbr7_t = flash_priv1bbr7_tt<"FLASH_PRIV1BBR7",baseaddress,232>;

template <std::uint32_t baseaddress>
using flash_priv1bbr8_t = flash_priv1bbr8_tt<"FLASH_PRIV1BBR8",baseaddress,236>;
...
template <std::uint32_t baseaddress>
using flash_priv2bbr5_t = flash_priv2bbr5_tt<"FLASH_PRIV2BBR5",baseaddress,256>;

template <std::uint32_t baseaddress>
using flash_priv2bbr6_t = flash_priv2bbr6_tt<"FLASH_PRIV2BBR6",baseaddress,260>;

template <std::uint32_t baseaddress>
using flash_priv2bbr7_t = flash_priv2bbr7_tt<"FLASH_PRIV2BBR7",baseaddress,264>;

template <std::uint32_t baseaddress>
using flash_priv2bbr8_t = flash_priv2bbr8_tt<"FLASH_PRIV2BBR8",baseaddress,268>;
