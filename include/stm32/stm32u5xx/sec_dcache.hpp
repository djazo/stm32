...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_cr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_sr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_ier_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_fcr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::wo,
  groov::field<"RESERVED2", std::uint32_t, 31, 5 ,access::ro>,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_rhmonr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_rmmonr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_whmonr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_wmmonr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::ro,
  groov::field<"RESERVED0", std::uint16_t, 31, 16 >,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_cmdrsaddrr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using dcache_cmdreaddrr_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::uint32_t baseaddress>
using dcache_cmdrsaddrr_t = dcache_cmdrsaddrr_tt<"DCACHE_CMDRSADDRR",baseaddress,40>;

template <std::uint32_t baseaddress>
using dcache_cmdreaddrr_t = dcache_cmdreaddrr_tt<"DCACHE_CMDREADDRR",baseaddress,44>;
