...
template <std::uint32_t baseaddress>
using dier_t = dier_tt<"DIER",baseaddress,8>;

template <std::uint32_t baseaddress>
using sr_t = sr_tt<"SR",baseaddress,12>;

template <std::uint32_t baseaddress>
using egr_t = egr_tt<"EGR",baseaddress,16>;

template <std::uint32_t baseaddress>
using ccmr1_output_t = ccmr1_output_tt<"CCMR1_Output",baseaddress,20>;

template <std::uint32_t baseaddress>
using ccmr1_input_t = ccmr1_input_tt<"CCMR1_Input",baseaddress,24>;

template <std::uint32_t baseaddress>
using ccer_t = ccer_tt<"CCER",baseaddress,28>;

template <std::uint32_t baseaddress>
using cnt_t = cnt_tt<"CNT",baseaddress,32>;

template <std::uint32_t baseaddress>
using psc_t = psc_tt<"PSC",baseaddress,36>;

template <std::uint32_t baseaddress>
using arr_t = arr_tt<"ARR",baseaddress,40>;

template <std::uint32_t baseaddress>
using rcr_t = rcr_tt<"RCR",baseaddress,44>;

template <std::uint32_t baseaddress>
using ccr1_t = ccr1_tt<"CCR1",baseaddress,48>;

template <std::uint32_t baseaddress>
using bdtr_t = bdtr_tt<"BDTR",baseaddress,52>;

template <std::uint32_t baseaddress>
using dcr_t = dcr_tt<"DCR",baseaddress,56>;

template <std::uint32_t baseaddress>
using dmar_t = dmar_tt<"DMAR",baseaddress,60>;

template <std::uint32_t baseaddress>
using or_t = or_tt<"OR",baseaddress,64>;

template <std::uint32_t baseaddress>
using af1_t = af1_tt<"AF1",baseaddress,68>;
