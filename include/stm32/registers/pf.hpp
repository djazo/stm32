...
// PF peripheral register templates
// Total unique registers: 3

// pf_ccsidr_v1: CCSIDR (version 1)
// Used by: PF.CCSIDR@stm32f722, PF.CCSIDR@stm32f723, PF.CCSIDR@stm32f730, PF.CCSIDR@stm32f732, PF.CCSIDR@stm32f733, ... +29 more
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using pf_ccsidr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             access::ro,
...
// pf_clidr_v1: CLIDR (version 1)
// Used by: PF.CLIDR@stm32f722, PF.CLIDR@stm32f723, PF.CLIDR@stm32f730, PF.CLIDR@stm32f732, PF.CLIDR@stm32f733, ... +29 more
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using pf_clidr_v1_tt =
  groov::reg<name,
             std::uint32_t,
             baseaddress + offset,
             access::ro,
...
// pf_ctr_v1: CTR (version 1)
// Used by: PF.CTR@stm32f722, PF.CTR@stm32f723, PF.CTR@stm32f730, PF.CTR@stm32f732, PF.CTR@stm32f733, ... +29 more
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
using pf_ctr_v1_tt =
