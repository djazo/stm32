...
// ADC_COMMON peripheral register templates
// Total unique registers: 3

// adc_common_adc1_ccr_v1: ADC1_CCR (version 1)
// Used by: ADC_Common.ADC1_CCR@stm32f3x4
...
// adc_common_adc1_cdr_v1: ADC1_CDR (version 1)
// Used by: ADC_Common.ADC1_CDR@stm32f3x4
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
...
// adc_common_adc1_csr_v1: ADC1_CSR (version 1)
// Used by: ADC_Common.ADC1_CSR@stm32f3x4
template <stdx::ct_string name,
          std::uint32_t   baseaddress,
          std::uint32_t   offset>
