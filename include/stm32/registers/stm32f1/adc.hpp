...
namespace adc {
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using cr1_dualmod_tt = groov::reg<
    name,
    std::uint32_t,
    baseaddress + offset,
    common::access::rw,
  ...
  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using jofrx_tt = groov::reg<
    name,
    std::uint32_t,
    baseaddress + offset,
    common::access::rw,
    groov::field<"RESERVED0", std::uint32_t, 31, 12, common::access::ro>,
    groov::field<"JOFFSET", std::uint16_t, 11, 0>>;

  template <stdx::ct_string name,
            std::uint32_t   baseaddress,
            std::uint32_t   offset>
  using htr_tt = groov::reg<
    name,
    std::uint32_t,
    baseaddress + offset,
    common::access::rw,
