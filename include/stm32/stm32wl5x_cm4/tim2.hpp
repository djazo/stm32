...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using tim2_or1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using tim2_af1_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
...
template <std::string name, std::uint32_t baseaddress, std::uint32_t offset>
  using tim2_tisel_tt = groov::reg<name,
 std::uint32_t,
  baseaddress + offset,
 access::rw,
  groov::field<"RESERVED1", std::uint32_t, 31, 12 ,access::ro>,
...
template <std::uint32_t baseaddress>
using tim2_or1_t = tim2_or1_tt<"TIM2_OR1",baseaddress,80>;

template <std::uint32_t baseaddress>
using tim2_af1_t = tim2_af1_tt<"TIM2_AF1",baseaddress,96>;

template <std::uint32_t baseaddress>
using tim2_tisel_t = tim2_tisel_tt<"TIM2_TISEL",baseaddress,104>;
