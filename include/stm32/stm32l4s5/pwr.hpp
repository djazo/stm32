...
template <std::uint32_t baseaddress>
using pucri_t = pucri_tt<"PUCRI",baseaddress,96>;

template <std::uint32_t baseaddress>
using pdcri_t = pdcri_tt<"PDCRI",baseaddress,100>;

template <std::uint32_t baseaddress>
using cr5_t = cr5_tt<"CR5",baseaddress,128>;
